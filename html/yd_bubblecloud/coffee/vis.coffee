...
texts = [
  {key:"culture",file:"culture.csv",name:"JapanTalk 之 日本文化"}
  {key:"food",file:"food.csv",name:"JapanTalk 之 日本美食"}
  {key:"travel",file:"travel.csv",name:"JapanTalk 之 日本旅遊"}
  {key:"news",file:"news.csv",name:"TravelTalk 之 旅先知"}
  {key:"map",file:"map.csv",name:"TravelTalk 之 旅地圖"}
  {key:"view",file:"view.csv",name:"TravelTalk 之 旅視野"}
]
